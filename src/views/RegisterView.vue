    ...
    <div class="container-fluid vh-100 d-flex align-items-center justify-content-center">
      <div class="row w-100">
        ...
        <div class="col-lg-6 d-none d-lg-flex align-items-center justify-content-center">
          <img src="../../public/undraw_software-engineer_xv60.svg" alt="Registro" class="img-fluid" style="max-width: 80%;">
        </div>
        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
          <div class="card shadow p-4 w-100" style="max-width: 400px; border: none; border-radius: 1rem;">
            ...
            <button @click="registerWithGoogle" class="btn w-100 mb-3" style="background-color: #4285F4; color: white;">
